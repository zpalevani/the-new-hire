...
| **Agent Skills / Agents CLI** | Skill with discoverable frontmatter: [`reference-implementation/escalation-triage/SKILL.md`](02-module-2-the-sop.md) · agents-cli scaffolding: [Module 3](03-module-3-first-assignment/) |
